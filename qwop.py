...
class Character:
    def __init__(self, physics_space: pm.Space, leg_muscle_strength: float):
        ...
        self.right_bicepts = PhysicsLimbWithMuscle(physics_space, group=1, width=15, height=80, mass=0.01, friction=0.6,
                                                    position=(230,400))
        self.left_bicepts = PhysicsLimbWithMuscle(physics_space, group=1, width=15, height=80, mass=0.01, friction=0.6,
                                                    position=(230,400))

        self.right_forearm = PhysicsLimb(physics_space, group=1, width=15, height=70, mass=0.01, friction=0.6,
                                                    position=(230,400))
        ...
        self.right_elbow_limit = pm.RotaryLimitJoint(self.right_bicepts.limb.body, self.right_forearm.body, radians(20),
                                            radians(155))

        self.left_elbow_limit = pm.RotaryLimitJoint(self.left_bicepts.limb.body, self.left_forearm.body, radians(20),
                                            radians(155))
        
        self.right_shoulder_limit = pm.RotaryLimitJoint(self.right_bicepts.limb.body, self.torso.body, radians(-45), 
                                            radians(70))
        
        self.left_shoulder_limit = pm.RotaryLimitJoint(self.left_bicepts.limb.body, self.torso.body, radians(-45),
                                            radians(70))
        ...
        self.body_left_leg_limit = pm.RotaryLimitJoint(self.left_leg.limb.body, self.torso.body, radians(-190),
                                            radians(0))
        self.body_right_leg_limit = pm.RotaryLimitJoint(self.right_leg.limb.body, self.torso.body, radians(-190),
                                            radians(0))
    ...
    def move_legs_q(self) -> None:
        ...
        self.right_bicepts.move_muscle(self.leg_muscle_strength, radians(120))
        self.left_bicepts.move_muscle(self.leg_muscle_strength, radians(-120))
